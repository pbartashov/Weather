...
final class DailyWeatherView: UIScrollView {
    ...
    //    var daysCollectionViewDataSource: UICollectionViewDataSource? {
//        get {
//            daysCollectionView.dataSource
//        }
//
//        set {
//            daysCollectionView.dataSource = newValue
//        }
//    }
//
//    var daysCollectionViewDelegate: UICollectionViewDelegate? {
//        get {
//            daysCollectionView.delegate
//        }
//
//        set {
//            daysCollectionView.delegate = newValue
//        }
//    }
...
//        airQualityIndexLabel.text = viewModel.airQualityValue
//        airQualityMarkLabel.text = viewModel.airQualityMark
//        airQualityDesctriptionLabel.text = viewModel.airQualityDesctription
    }
...
extension DailyWeatherView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: DailyWeatherDaysCollectionViewCell.identifier,
                                                          for: indexPath)
        ...
        cell.setup(with: weather.weekDayMonth)
#warning("WRONG")
...
//        if let cell = collectionView.cellForItem(at: indexPath) as? DailyWeatherDaysCollectionViewCell {
//            cell.setSelectedAppearence()
//        }
...
//
//    private var itemsPerRow: CGFloat { CGFloat(viewModel.weathers.count) }
